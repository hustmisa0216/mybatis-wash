    ...
    public void update(int vendorId, CharModifier charModifier) {
        ...
        for (int siteId : s_date_map.keySet()) {
            ...
            for (int date : date_map.keySet()) {
                ...
                UpdateWrapper<StatementVendorDaily> statementVendorDailyUpdateWrapper = new UpdateWrapper<>();
            ...
            UpdateWrapper<StatementSite> statementSiteUpdateWrapper = new UpdateWrapper<>();
        ...
        for (int siteId : s_month_map.keySet()) {
            ...
            for (int date : month_map.keySet()) {
                ...
                UpdateWrapper<StatementMonthly> statementDailyUpdateWrapper = new UpdateWrapper<>();
